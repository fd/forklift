...
dist: build
	...
	GOOS=linux GOARCH=386 go build -o dist/forklift-linux-386/bin/forklift ./*.go
	GOOS=linux GOARCH=amd64 go build -o dist/forklift-linux-amd64/bin/forklift ./*.go
	GOOS=darwin GOARCH=386 go build -o dist/forklift-darwin-386/bin/forklift ./*.go
	GOOS=darwin GOARCH=amd64 go build -o dist/forklift-darwin-amd64/bin/forklift ./*.go
